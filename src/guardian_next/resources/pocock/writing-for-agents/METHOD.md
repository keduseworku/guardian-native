...
For Codex skill packaging, follow the installed skill-creator guidance and current official Codex documentation. This selection uses one automatically discovered Guardian router and on-demand references.
...
- **By invocation**, skill-specific: use the existing Guardian router; add a separate skill only when independent discovery is needed.
